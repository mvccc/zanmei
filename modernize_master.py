...
def create_sample_slides():
    ...
    # Body text
    body_box = slide.shapes.add_textbox(Inches(2), Inches(2.5), Inches(9.33), Inches(4))
...
阿們"""
    ...
    # Citation
    citation_box = slide.shapes.add_textbox(Inches(1), Inches(0.5), Inches(11.33), Inches(0.8))
    ...
    # Verse text
    verse_box = slide.shapes.add_textbox(Inches(1.5), Inches(2), Inches(10.33), Inches(4))
